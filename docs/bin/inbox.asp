...
if output == None:
	...
	sqlgate.cn2 = ""
	requests = TimeTree2.inbox.Requests(utilitygate=utilitygate, xmlgate=xmlgate, sqlgate=sqlgate, formgate=formgate, session=Session.SessionID, user="aib", appname="josefka", cachepath=cachepath, project="josefka")
