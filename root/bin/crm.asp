...
requests = None
cachepath="C:/projects/josefka/machine/cache/crm/"
...
if output == None:
	...
	requests = TimeTree2.crm.Requests(utilitygate=utilitygate, xmlgate=xmlgate, sqlgate=sqlgate, formgate=formgate, session=Session.SessionID, user="aib", appname="josefka", cachepath=cachepath, project="josefka")
...
utilitygate.recordSystemUsage ("template","3",start)
%>
